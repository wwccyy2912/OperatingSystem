 ...
 * §三/§五).  NOTE: gating of this syscall to the perm-engine lands in
 * P1, consistent with the currently unrestricted sys_cap_create.
 ...
 * Gating to perm-engine lands in P1.
 */
