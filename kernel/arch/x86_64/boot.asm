...
%define CR0_PG          (1 << 31)
%define CR4_PAE         (1 << 5)
%define CR4_OSFXSR      (1 << 9)    ; Enable SSE FXSAVE/FXRSTOR
%define CR4_OSXMMEXCPT  (1 << 10)   ; SIMD floating-point exception support
%define EFER_LME        (1 << 8)
...
.fill_pdp_loop:
        ...
        ; -------------------------------------------------------------------------
        ; Step 8: Enable PAE (CR4 bit 5) + SSE (CR4 bits 9-10)
        ; OSFXSR enables FXSAVE/FXRSTOR to manage SSE state;
        ; OSXMMEXCPT lets the kernel handle SIMD exceptions.
        ; -------------------------------------------------------------------------
        mov eax, cr4
