...
extern char fs_virtio_blk_driver_elf_start[], fs_virtio_blk_driver_elf_end[], fs_virtio_blk_driver_elf_size[];
...
void blob_init(void)
{
        ...
        (void)blob_register("fs_virtio_blk_driver", fs_virtio_blk_driver_elf_start,
                                                (u64)fs_virtio_blk_driver_elf_size);
        ...
        (void)blob_register("sbox_demo", sbox_demo_elf_start,
                                                (u64)sbox_demo_elf_size);
        ...
        (void)blob_register("sbox_demo_noperm", sbox_demo_elf_start,
                                                (u64)sbox_demo_elf_size);
}
