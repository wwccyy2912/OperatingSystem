...
{
        return (int)sys_call(SYS_IPC_RECV, port, (long)buf, (long)len,
                         (long)tok, 0);
}
...
{
        return (int)sys_call(SYS_IPC_CALL, port, (long)req, req_len,
                         (long)resp, (long)resp_len);
}
...
{
        return (int)sys_call(SYS_THREAD_CREATE, (long)entry, (long)arg,
                         priority, 0, 0);
}
...
{
        return (int64_t)sys_call(SYS_BLK_READ, (long)disk, (long)lba,
...
int64_t sys_blk_write(uint64_t disk, uint64_t lba, uint64_t count,
                                            const void *buf)
{
        return (int64_t)sys_call(SYS_BLK_WRITE, (long)disk, (long)lba,
                             (long)count, (long)buf, 0);
}
...
int process_create(const char *name, const void *elf, unsigned long size)
{
        ...
        return (int)sys_call(SYS_PROCESS_CREATE, (long)name, (long)&img.desc,
                         (long)elf, (long)size, 0);
}

int process_wait(int pid, int *exit_code)
{
        return (int)sys_call(SYS_PROCESS_WAIT, (long)pid, (long)exit_code,
                         0, 0, 0);
}
...
{
        return (int)sys_call(SYS_PROC_INFO_BY_SUBJECT, (long)subject, (long)out,
                         0, 0, 0);
}
...
sighandler_t signal(int signum, sighandler_t handler)
{
        ...
        return (sighandler_t)sys_call(SYS_SIGNAL, signum, (long)handler,
                                                                    (long)(uintptr_t)__restore_rt, 0, 0);
}
...
{
        return (int)sys_call(SYS_CAP_CREATE_ATOM, (long)atom, (long)rights,
                         (long)expiry_ticks, (long)quota, (long)scope_hash);
}
...
{
        return (int)sys_call(SYS_CAP_REVOKE_BY_ATOM, (long)subject, (long)atom,
                         (long)scope_hash, 0, 0);
}
...
{
        return (int)sys_call(SYS_CAP_GRANT_TO_SUBJECT, (long)subject, (long)atom,
                         (long)rights, (long)expiry_ticks, (long)quota);
}

int cap_has_atom(uint64_t subject, atom_id_t atom)
{
        return (int)sys_call(SYS_CAP_HAS_ATOM, (long)subject, (long)atom,
                         0, 0, 0);
}
...
{
        return (int)sys_call(SYS_IPC_RECV_FROM, port, (long)buf, (long)len,
                         (long)tok, (long)sender_subject);
}
